module github.com/takekazuomi/grpczap01
...
require (
	...
	github.com/plusmedi/go-coreg/funcname/v2 v2.0.0 // indirect
	github.com/plusmedi/go-coreg/grpc/richerror v1.1.0 // indirect
